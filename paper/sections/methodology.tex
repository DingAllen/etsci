...
Our DS-based ensemble framework consists of three main components: (1) belief assignment from neural network outputs, (2) evidence fusion using Dempster's rule, and (3) decision making with uncertainty quantification. Figure~\ref{fig:framework} illustrates the overall architecture.
